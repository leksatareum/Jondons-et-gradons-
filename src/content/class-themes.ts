...
export const CLASS_THEMES: Record<string, ClassTheme> = {
  ...
  rodeur: {
    label: 'Braise et fer', accent: '#f08a2e', accentBright: '#ffb15c', accentGlow: 'rgba(240,138,46,.34)',
    gold: '#d4ab5c', goldBright: '#f6e0a8', goldDim: 'rgba(150,116,58,.55)',
  },
  druide: {
    label: 'Sève et mousse', accent: '#7fae4f', accentBright: '#a8d67a', accentGlow: 'rgba(127,174,79,.34)',
    gold: '#c3a05a', goldBright: '#eddba0', goldDim: 'rgba(140,113,58,.55)',
  },
  occultiste: {
    label: 'Arcane et argent', accent: '#9b6fd6', accentBright: '#c6a3f2', accentGlow: 'rgba(155,111,214,.36)',
    gold: '#b9c3d6', goldBright: '#eef3fb', goldDim: 'rgba(120,128,148,.55)',
  },
  magicien: {
    label: 'Saphir et rune', accent: '#5a93d6', accentBright: '#9dc3f0', accentGlow: 'rgba(90,147,214,.34)',
    gold: '#b3c2d4', goldBright: '#e6eefa', goldDim: 'rgba(110,126,148,.55)',
  },
  ensorceleur: {
    label: 'Pourpre et or rouge', accent: '#d64560', accentBright: '#f28aa0', accentGlow: 'rgba(214,69,96,.34)',
    gold: '#c7895a', goldBright: '#f0c99a', goldDim: 'rgba(150,100,58,.55)',
  },
  clerc: {
    label: 'Aube et or sacré', accent: '#e8b13a', accentBright: '#f8d888', accentGlow: 'rgba(232,177,58,.36)',
    gold: '#d8c48a', goldBright: '#f8edc9', goldDim: 'rgba(150,132,80,.55)',
  },
  paladin: {
    label: 'Serment et lumière', accent: '#e0a83a', accentBright: '#f6cf80', accentGlow: 'rgba(224,168,58,.36)',
    gold: '#e6c67a', goldBright: '#faeab3', goldDim: 'rgba(160,132,60,.55)',
  },
  barbare: {
    label: 'Sang et fer battu', accent: '#d4432f', accentBright: '#f28a70', accentGlow: 'rgba(212,67,47,.36)',
    gold: '#9a8f82', goldBright: '#e3dbcf', goldDim: 'rgba(110,102,90,.55)',
  },
  guerrier: {
    label: 'Acier et poudre', accent: '#6f93b8', accentBright: '#a8c6e2', accentGlow: 'rgba(111,147,184,.32)',
    gold: '#a8a8ac', goldBright: '#e2e2e6', goldDim: 'rgba(110,110,116,.55)',
  },
  moine: {
    label: 'Jade et bambou', accent: '#4fae8a', accentBright: '#8ad6ba', accentGlow: 'rgba(79,174,138,.34)',
    gold: '#c7ad78', goldBright: '#eee0bf', goldDim: 'rgba(130,110,70,.55)',
  },
  roublard: {
    label: 'Prune et étain', accent: '#9a5fc2', accentBright: '#c99ce8', accentGlow: 'rgba(154,95,194,.34)',
    gold: '#8f8578', goldBright: '#d9d0c2', goldDim: 'rgba(100,92,80,.55)',
  },
  barde: {
    label: 'Rose et bronze', accent: '#d6598f', accentBright: '#f2a0c2', accentGlow: 'rgba(214,89,143,.34)',
